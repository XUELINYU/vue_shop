      ...
      >
        ...
        >
          ...
          <el-tab-pane label="商品内容" name="4">
            ...
            <!-- 添加商品按钮 -->
            <el-button type="primary" size="small" class="btnAdd" @click="add">添加商品</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    beforeTabLeave(activeName, oldActiveName) {
      // console.log('即将进入标签页的名称是' + activeName)
      // console.log('即将离开标签页的名称是' + oldActiveName)
      // 阻止切换
      // return false
    ...
    handleSuccess(response) {
      ...
      // 获取图片的临时路径
      let picPath = response.data.tmp_path
      // 1.拼接得到图片信息对象
      const picInfo = { pic: picPath }
